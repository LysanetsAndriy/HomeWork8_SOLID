...
/*
Порушено принцип Single Responsibility Principle, оскільки клас EmailSender відповідає як за відправку повідомлень, так і за
логування через консоль. Це робить його менш гнучким і складнішим при підтримуванні у випадку змін в логуванні.
Для виправлення цього можна використовувати принцип Open/Closed Principle, розділяючи логування на окремий клас
*/
class Email
{
